...
export const ACCESS_DENIED_UPDATE_COMPANY =
  'Access Denied: Only the company creator is allowed to update company details.';
export const ACCESS_DENIED_JOB_POST =
  'Access Denied: Only the job creator is allowed to request this job listing.';
export const ACCESS_DENIED_COMPANY =
  'Access Denied: Only the Company creator is allowed to request this listing.';
...
export const COMPANY_NOT_FOUND =
  "Company Not Found: The requested company doesn't exist.";
/**
 * @status  409 - CONFLICT
 */
...
export const COMPANY_CREATED =
  'Company Created: The company has been successfully created.';
...
export const COMPANY_DELETED =
  'Company Deleted: The company has been successfully deleted.';
...
export const COMPANY_UPDATED =
  'Company Updated: The company has been successfully updated.';
